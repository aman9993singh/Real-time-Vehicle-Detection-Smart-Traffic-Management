...
S2: Install necessary liberaries like: Ultralytics, cvzone, numpy, tensorflow
S3: If you have your own trained model you can use that or you can slect mine to for the project
